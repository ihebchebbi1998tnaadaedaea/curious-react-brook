...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        title: "Notebook Personnalisable",
        description: "Notebooks personnalisés pour votre entreprise",
        image: "/ProduitsMarketing/CarnetPeronalise.jpg",
        path: "/produits-marketing/notebook-personnalisable"
      },
      {
        title: "Notebook Restaurant",
        description: "Notebooks spécialement conçus pour les restaurants",
        image: "/ProduitsMarketing/CarnetPeronalise.jpg",
        path: "/produits-marketing/notebook-restaurant"
      }
    ]
  }
];
